...
## Splines as Adaptive Basis Function Model
...
title("Linear Spline Basis Functions")
```
...
- [*Linear splines*]{.green} (continuous piecewise linear): *8 - 3 constraints = 5 dfs.*
...
## [B-Splines](https://en.wikipedia.org/wiki/B-spline#:~:text=A%20B%2Dspline%20function%20is,using%20a%20number%20of%20points.) Basis Functions
...
- [What is the degree of functions in each region]{.green}
