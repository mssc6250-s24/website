...
$$f(x^*) \mid y_1, \dots, y_n \sim N\left( \bmu^*, \bSigma^*\right), \quad \bmu^* = K_{*}^T{\color{red}{(K + \sigma^2I)^{-1}}}{\bf y}, \quad \bSigma^* = K_{**} - K_{*}^T{\color{red}{(K + \sigma^2I)^{-1}}}K_{*}$$
with ${\bf y} = \left(y_1, \dots, y_n\right)^T$
