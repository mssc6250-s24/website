...
::: r-fit-text
[So what is Machine Learning?]{.highlight-red}
:::
...
> _"A **computer program** is said to learn from **experience** *E* with respect to some class of tasks *T* and performance measure *P* if its performance at tasks in *T*, as measured by *P*, [improves with experience]{style="color: red;"} *E*."_
...
<!-- # ```{r} -->
<!-- # #| out-width: 50% -->
<!-- # #| fig-cap: http://statweb.stanford.edu/~tibs/stat315a/glossary.pdf -->
<!-- # #| fig-align: center -->
<!-- # knitr::include_graphics("./images/02-overview/glossary.png") -->
<!-- # ``` -->
...
```{r}
#| out-width: "50%"
#| fig-cap: "Source: The elements of statistical learning"
...
On the basis of the training data (*E*) we'd like to :

- (*T*) **Prediction**: [Accurately predict unseen test cases.]{style="color:green"}
    + <span style="color:blue">Given a new test input (age, year, education), what is predicted salary level?</span>
    + <span style="color:blue">Given a new bunch of words in the email, does the model classify the email correctly?</span>

. . .

- (*T*) **Inference** [Understand which inputs affect the outcome, and how.]{style="color:green"}
...
- (*P*) [Assess the quality of our predictions and inferences.]{style="color:green"}
