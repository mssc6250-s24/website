...
- In KNN, we don't have parameters $\bbeta$, and $f(\bx_0) = \bx_0'\bbeta$ in regression.^[$\widehat{y}_0 = \widehat{f}(x_0)$.]
...
#| fig-align: center
  ...
  par(mar = c(4, 4, 0, 0))
  library(car)
  dataEllipse(x, y, levels=c(0.6, 0.9), col = c("black", 4), pch = 19, las = 1)
